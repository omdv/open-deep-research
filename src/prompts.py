...
<Task>
You need to clean up information gathered from tool calls, web searches, and API calls in the existing messages.
...
<Guidelines>
1. Your output findings should be fully comprehensive and include ALL of the information and sources that the researcher has gathered from tool calls, web searches, and API calls. It is expected that you repeat key information verbatim.
...
7. API tool calls (like financial data APIs) should be treated as valid sources. When you see tool outputs that contain "Source:" information, preserve these as citations.
</Guidelines>
...
- Sources can be web URLs OR API endpoints - both are valid sources
- When you see tool output with "Source: [Title]: [URL]" format, use that as your source
- End with ### Sources that lists each source with corresponding numbers
- Number sources sequentially without gaps (1,2,3,4...) in the final list regardless of which sources you choose
- Example format for web sources:
  [1] Source Title: URL
- Example format for API sources:
  [1] Financial Modeling Prep - Company Profile (AAPL): https://financialmodelingprep.com/api/v3/profile/AAPL
</Citation Rules>

Critical Reminder: It is extremely important that any information that is even remotely relevant to the user's research topic is preserved verbatim (e.g. don't rewrite it, don't summarize it, don't paraphrase it). This includes financial data, API responses, and any source attribution information.
"""
